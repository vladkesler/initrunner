...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/latest-v1.33.1-%2334D058" alt="v1.33.1">
...
> **v1.33.1** -- Team mode v2, installed role name resolution, streaming output. See the [Changelog](CHANGELOG.md).
