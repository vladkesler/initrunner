...
<p align="center">
  ...
  <a href="tests/"><img src="https://img.shields.io/badge/tests-2957+-%2334D058" alt="Tests"></a>
  <img src="https://img.shields.io/badge/latest-v1.24.0-%2334D058" alt="v1.24.0">
...
> **v1.24.0** -- Replace zvec with LanceDB (pure-Python columnar vector store), add Python 3.13 support. See the [Changelog](CHANGELOG.md).
...
<p align="center"><sub>v1.24.0</sub></p>
