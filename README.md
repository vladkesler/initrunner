...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/latest-v1.17.0-%2334D058" alt="v1.17.0">
...
> **v1.17.0** -- Compose auto-routing with intent sensing, keyword and sense strategies for delegate sinks. See the [Changelog](CHANGELOG.md).
...
<p align="center"><sub>v1.17.0</sub></p>
