...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/latest-v1.16.0-%2334D058" alt="v1.16.0">
...
> **v1.16.0** -- Async compose orchestrator, async tool execution, and native async API streaming. See the [Changelog](CHANGELOG.md).
