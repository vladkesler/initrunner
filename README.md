...
> **v2026.4.7**: Live tool activity panel, token/cost meter, timeline view for agents/flows/teams, quick-run drawer. See the [Changelog](CHANGELOG.md).
...
<p align="center"><sub>v2026.4.7</sub></p>
