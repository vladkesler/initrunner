...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/latest-v1.35.1-%2334D058" alt="v1.35.1">
...
> **v1.35.1** - Tool event observability, `compose new` scaffolding (pipeline/fan-out/route patterns), `--format` output control (auto/json/text/rich), `--list-templates` for role generation. See the [Changelog](CHANGELOG.md).
...
<p align="center"><sub>v1.35.1</sub></p>
