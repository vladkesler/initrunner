...
<!-- Drawer panel -->
<div class="fixed inset-y-0 right-0 z-50 flex w-full max-w-lg flex-col border-l border-edge border-t-2 border-t-accent-primary/20 bg-surface-0 shadow-2xl">
	<!-- Header -->
	...
	<div class="flex-1 overflow-y-auto p-5">
		<div class="space-y-5">
			...
			<div class="grid grid-cols-2 gap-3">
				<div>
					<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Agent</div>
					<div class="font-mono text-[13px] text-fg-muted">{record.agent_name}</div>
				</div>
				<div>
					<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Model</div>
					<div class="font-mono text-[13px] text-fg-muted">{record.model}</div>
				</div>
				<div>
					<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Provider</div>
					<div class="font-mono text-[13px] text-fg-muted">{record.provider}</div>
				</div>
				<div>
					<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Timestamp</div>
					<div class="font-mono text-[13px] text-fg-muted">{formatTimestamp(record.timestamp)}</div>
				</div>
				<div>
					<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Tokens</div>
					<div class="font-mono text-[13px] text-fg-muted">
						{record.tokens_in.toLocaleString()} in / {record.tokens_out.toLocaleString()} out
					</div>
				</div>
				<div>
					<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Duration</div>
					<div class="font-mono text-[13px] text-fg-muted">{record.duration_ms.toLocaleString()}ms</div>
				</div>
				<div>
					<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Tool Calls</div>
					<div class="font-mono text-[13px] text-fg-muted">{record.tool_calls}</div>
				</div>
				{#if record.trigger_type}
					<div>
						<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Trigger</div>
			...
			<!-- Run ID -->
			<div>
				<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Run ID</div>
			...
			{#if record.error}
				<div>
					<div class="mb-1 font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fail">Error</div>
			...
			<div>
				<div class="mb-2 flex items-center justify-between">
					<div class="font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Prompt</div>
					<button
			...
			<div>
				<div class="mb-2 flex items-center justify-between">
					<div class="font-mono text-[11px] font-medium uppercase tracking-[0.1em] text-fg-faint">Output</div>
					<button
						class="text-[13px] text-fg-faint transition-[color] duration-150 hover:text-fg-muted"
