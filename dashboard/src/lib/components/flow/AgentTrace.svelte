...
<div class="mt-2">
	...
	>
		...
		/>
		<span class="font-mono">{steps.length} agent{steps.length !== 1 ? 's' : ''}, {totalDuration}ms</span>
	</button>
				...
				<div class="flex gap-3">
					...
					<div class="pb-3">
						<div class="flex items-center gap-2">
							<span class="font-mono text-[13px] font-semibold text-fg">{step.agent_name}</span>
