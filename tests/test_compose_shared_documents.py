"""Tests for shared document stores in compose."""
...
from initrunner.compose.orchestrator import apply_shared_documents
...
class TestComposeSpecWithSharedDocuments:
    def test_compose_spec_with_shared_documents(self):
        spec = ComposeSpec(
            services={
                "researcher": ComposeServiceConfig(role="researcher.yaml"),
                "writer": ComposeServiceConfig(role="writer.yaml"),
            },
    ...
    def test_compose_definition_with_shared_documents(self):
        data = {
...
class TestBuildServicesWiresSharedDocuments:
    ...
    def test_build_services_wires_shared_documents(
        ...
        orch = ComposeOrchestrator(compose, tmp_path)
