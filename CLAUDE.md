...
schemas/                 # agent.v3.json, generated by `initrunner schema` (test keeps it current)
...
| Editor support (JSON Schema, `initrunner schema`, `schemas/agent.v3.json`) | `docs/getting-started/editor-support.md` |
