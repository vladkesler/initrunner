...
PROVIDER_MODELS: dict[str, list[tuple[str, str]]] = {
    ...
    "groq": [
        ...
        ("llama-3.3-70b-versatile", "Llama 70B, high quality"),
        ("llama-3.1-8b-instant", "Llama 8B, lowest latency"),
    ],
    "mistral": [
        ("mistral-large-latest", "Frontier (best quality)"),
        ("mistral-small-latest", "Balanced (fast, efficient)"),
        ("codestral-latest", "Code-optimized"),
        ("devstral-small-2505", "Agentic coding"),
    ],
    "cohere": [
        ("command-a", "Frontier (256K context)"),
