...
- prompt is the system prompt. Combine extracted system_prompt and instructions into \
...
- Do NOT add memory. PydanticAI RunContext deps do not map to InitRunner memory.
- If temperature or max_tokens were extracted, include them in model.
- If usage_limits were extracted, map them to guardrails:
